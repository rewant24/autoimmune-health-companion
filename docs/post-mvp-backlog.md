...
- **Post-MVP shape:** Opt-in daily or weekly digest notification (*"Sakhi has 2 things to show you"*) — never per-insight alerts. Strictly user-initiated opt-in during settings.
...
**Revenue track** (176-point ceiling, highest of the three). Sakhi is a natural fit: chronic-illness patients have sustained willingness-to-pay, waitlist demand is already present, and the doctor-report artifact is a tangible outcome with obvious perceived value (a single visit improved = price justified).

### Tier structure (v0 proposal)

| Tier | Price (India) | Price (International) | What's unlocked |
|---|---|---|---|
| **Free — "Sakhi Friend"** | ₹0 | $0 | Daily voice check-in, Memory (last 30 days), 1 doctor report per month, intake tracking, Community access |
| **Paid — "Sakhi Companion"** | ₹199/month or ₹1,499/year (~37% off) | $4.99/month or $39/year | Unlimited Memory history, unlimited doctor reports, unlimited PDF regenerations, Patterns view (long-horizon insights), WhatsApp share, priority support, future: wearable integrations + support-system shared view |

**Why these numbers:**
- **₹199/month** anchors below the price of a single OPD consultation (₹500–1,500 in Tier-1 cities) — *"one visit you don't have to repeat pays for a year of Sakhi."*
